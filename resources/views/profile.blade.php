...
<div class="d-flex flex-column justify-content-center">
    <div class="profile-container">
        ...
        <p style="align-self: flex-start"><span style="font-weight: bold">Age: </span> {{ $user->age }}</p>
        <p style="align-self: flex-start"><span style="font-weight: bold">Phone Number: </span> {{ $user->phone_num }}</p>
        <p style="align-self: flex-start"><span style="font-weight: bold">Linked In: </span> <a href="{{ $user->linkedin_link }}">{{ $user->linkedin_link }}</a></p>
    ...
    <div class="visibility-container">
        <h1 class="mb-5">{{ $user->username }}'s Inventory </h1>
